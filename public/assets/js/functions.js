        ...
        if (e.isVariableDefined(p)) {
            ...
            pWrap.forEach(item => {
                ...
                var priceSwitch = item.querySelector('.price-toggle'),
                    ...
                    billingCycleElement = item.querySelectorAll('.billing-cycle'); // Select billing cycle elements
    
                priceSwitch.addEventListener('change', function () {
                    if (priceSwitch.checked) {
                        priceElement.forEach(pItem => {
                            var annualPrice = pItem.getAttribute('data-annual-price');
                            pItem.innerHTML = annualPrice;
                        });
                        billingCycleElement.forEach(bItem => {
                            bItem.innerHTML = "Lifetime"; // Set text to "lifetime"
                        });
                    } else {
                        priceElement.forEach(pItem => {
                            var monthlyPrice = pItem.getAttribute('data-monthly-price');
                            pItem.innerHTML = monthlyPrice;
                        });
                        billingCycleElement.forEach(bItem => {
                            bItem.innerHTML = "/month"; // Set text to "/month"
                        });
                    }
                });
            });
